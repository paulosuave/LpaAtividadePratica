...
from code.Const import COLOR_YELLOW, SCORE_POS, MENU_OPTION, COLOR_RED, COLOR_BLACK
...
class Score:
    ...
    def save(self, game_mode: str, player_score: list[int]):
        ...
        name = ''
        text = 'Digite o nome do PLAYER 1:'
        ...
        while True:
            ...
            if game_mode == MENU_OPTION[2]:
                if player_score[0] >= player_score[1]:
                    ...
                    text = 'Digite o nome do PLAYER 2:'
            ...
            self.score_text(30, name, COLOR_BLACK, SCORE_POS['Name'])
            pygame.display.flip()
            pass
